...
if __name__ == "__main__":
    ...
    for f in os.listdir("problems/spaceship_christofides_serdyukov"):
        if not f.startswith("raw_") and f != 'previews' and not f.endswith('.py'):
            with open(f"problems/spaceship_christofides_serdyukov/{f}", "r") as source:
                ...
                d.save_svg(f"svgs_line_cs/{f}.svg")
